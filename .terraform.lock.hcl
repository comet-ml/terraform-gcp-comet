...
provider "registry.terraform.io/hashicorp/google" {
  version     = "5.18.0"
  constraints = ">= 3.33.0, >= 3.53.0, >= 3.83.0, >= 3.88.0, >= 4.25.0, >= 4.48.0, >= 4.50.0, >= 4.51.0, >= 4.64.0, ~> 5.0, >= 5.7.0, >= 5.9.0, < 6.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/google-beta" {
  version     = "5.18.0"
  constraints = ">= 3.53.0, >= 4.48.0, >= 4.50.0, >= 4.64.0, >= 5.5.0, >= 5.7.0, < 6.0.0"
  hashes = [
    "h1:ZCSiFK6pwYAcGYehXykIFXWTlu3wUG5lm99Phs5qJkQ=",
